...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            var styles = ["cubicStyleBlue", "cubicStylePurple", "cubicStyleYellow", "cubicStylePink", "cubicStyleGreen"];
            var TurnTool = {
                ...
                getNext : function(corner) {
                    ...
                    if (index >= 0) {
                        index = index + 1;
                        index = (index < this.corners.length) ? index : index - this.corners.length;
                        ...
                        if (index >= 0) {
                            index = index + 1;
                            index = (index < this.realtives.length) ? index : index - this.realtives.length;
            ...
            function Cubic(x, y) {
                ...
                this.isValid = function() {
                    return this.x >= 0 && this.x < this.getXLimit() && this.y >= 0 && this.y < this.getYLimit();
                };
                ...
                this.isRenderable = function() {
                    ...
                    return this.getCubic(x, y) != null && this.getCubic(x, y).attr("class").indexOf("cubicStyle") < 0;
                };
                ...
                this.clear = function() {
                    ...
                    if (cub != null) {
                        cub.attr("class", cub.attr("class").replace(/cubicStyle[^\s]+/g, ''))
                    }
                };
            ...
            function TetrisStyle(rows, columns, disables) {
                ...
                this.turn = function() {
                    return new TetrisStyle(this.columns, this.rows, TurnTool.turn(this.disables));
                };
                this.disable = function(ary) {
                    if (this.disables.length <= 0) return;
                    var corner = null;
                    var realtive = null;
            ...
            function Tetris(context) {
                ...
                this.init = function() {
                    this.styleClass = this.styleClasses[range(0, this.styleClasses.length - 1)];
                ...
                this.createCubics = function() {
                    ...
                    var ref = arguments.length == 2 ? arguments[1] : {x : 0, y :0};
                ...
                this.move = function (act) {
                    if (!this.moveAble(act)) return false;
    ...
    <body>
        <div id="back" style="background-color:teal" class="chessBackground">
        </div>
        <div id="operation">

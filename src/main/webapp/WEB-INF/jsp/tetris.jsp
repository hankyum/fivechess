...
<script type="text/javascript">
	...
	function Tetris(context) {
		...
		this.cubicStyles = [ new TetrisStyle(1, 4, []),
				new TetrisStyle(4, 1, []), new TetrisStyle(2, 2, []),
		...
		this.rights = function() {
			var res = [];
			var cubics = arguments.length == 1 ? arguments[0] : this
					.getCubics();
			for ( var i in cubics) {
...
<body>
	<div id="back" style="background-color: teal" class="chessBackground"></div>
	<div id="operation">
		<div>
